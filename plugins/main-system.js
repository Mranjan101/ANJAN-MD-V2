...
let handler = async (m, { conn }) => {
  ...
  try {
    ...
    let infobt = `
🔰 *I'm MR-ANJAN-V2.* *A WhatsApp Advanced bot with Rich Exciting features* *Created By ANJAN*. 🔰
 ...
 *✪  Deploy:*${created_at} 
 *✪  Repo:*  ${html_url}
 *✪  Scan:*  https://replit.com/@dharanjan22/-2-PAIR-CODE-1
 *✪ Visit For Help:* https://wa.me/919883457657
